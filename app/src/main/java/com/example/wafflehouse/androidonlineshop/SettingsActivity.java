...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Please wait as changes are saved");
    ...
    {
        DatabaseReference userReference = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone());
