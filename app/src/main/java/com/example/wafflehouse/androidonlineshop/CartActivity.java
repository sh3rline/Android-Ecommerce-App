...
import com.example.wafflehouse.androidonlineshop.Model.Cart;
import com.example.wafflehouse.androidonlineshop.Prevalent.Prevalent;
import com.example.wafflehouse.androidonlineshop.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity
{
                                    ...
                                    cartListReference.child("User View")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>()
                                            {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task)
                                                {
                                                    ...
                                                    {
                                                        Toast.makeText(CartActivity.this, "Item Successfully removed",
    ...
    {
        DatabaseReference ordersReference = FirebaseDatabase.getInstance().getReference().child("Orders")
                .child(Prevalent.currentOnlineUser.getPhone());
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Your order has been successfully shipped");
